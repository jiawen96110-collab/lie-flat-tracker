...
window.VALUATION_GROUPS = {
  us: {
    ...
    reserve: 35.0,
    records: [
      { ticker:'MRVL', sym:'usMRVL', market:'US', name:'迈威尔科技', buy:[133.0,177.3], fair:[266.0,354.7], sell:[372.4,496.6], holding:7.1, targetHolding:7.1, snapshot:195.6 },
      ...
      { ticker:'NEM',  sym:'usNEM',  market:'US', name:'纽蒙特',     buy:[74,98],       fair:[147,197],     sell:[206,275],     holding:12.8, targetHolding:12.6, snapshot:92.1 },
      { ticker:'NVDA', sym:'usNVDA', market:'US', name:'英伟达',     buy:[143,190],     fair:[285,380],     sell:[399,532],     holding:0, targetHolding:0, snapshot:206.9 },
      { ticker:'SNDK', sym:'usSNDK', market:'US', name:'闪迪',       buy:[1098,1464],   fair:[2196,2928],   sell:[3074,4099],   holding:31.5, targetHolding:30.4, snapshot:1440.0 },
      { ticker:'BE',   sym:'usBE',   market:'US', name:'Bloom Energy', buy:[119.0,158.7], fair:[238.0,317.4], sell:[333.2,444.3], holding:7.8, targetHolding:9.3, snapshot:185.2 },
      ...
      { ticker:'NOK',  sym:'usNOK',  market:'US', name:'诺基亚',     buy:[7.2,9.6],     fair:[14.4,19.2],   sell:[20.2,26.9],   holding:5.9, targetHolding:6.7, snapshot:9.1 }
    ]
  },
  ah: {
    label: 'A / H 股估值',
    ...
    reserve: 34.0,
    records: [
      { ticker:'300502', sym:'sz300502', market:'A股', name:'新易盛',   buy:[443,591],       fair:[886,1181],     sell:[1329,1772], holding:18.3, targetHolding:33.0, snapshot:476.0 },
      { ticker:'300308', sym:'sz300308', market:'A股', name:'中际旭创', buy:[874,1166],      fair:[1749,2332],    sell:[2448,3265], holding:17.2, targetHolding:33.3, snapshot:1052.0 },
      ...
      { ticker:'601898', sym:'sh601898', market:'A股', name:'中煤能源', buy:[10.6,10.6],     fair:[20.0,20.0],    sell:[25.4,25.4], holding:15.0, targetHolding:0, snapshot:13.7 },
      ...
      { ticker:'603993', sym:'sh603993', market:'A股', name:'洛阳钼业', buy:[13,18],         fair:[27,36],        sell:[38,50], holding:15.6, targetHolding:0, snapshot:18.6 },
